defmodule ReventDispatcher do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(ReventDispatcher.Repo, []),
      # Start the endpoint when the application starts
      supervisor(ReventDispatcher.Endpoint, []),
    ...
    opts = [strategy: :one_for_one, name: ReventDispatcher.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ReventDispatcher.Endpoint.config_change(changed, removed)
    :ok
  end
end
